...
if ($sql->connect_error) {
    echo json_encode(['status' => false, 'msg' => '❌ При соединении с базой данных произошла ошибка: ' . $sql->connect_error, 'status_code' => 401], 448);
} else {
    echo json_encode(['status' => true, 'msg' => '✅ Операция с базой данных успешно завершена.', 'status_code' => 200], 448);
}
